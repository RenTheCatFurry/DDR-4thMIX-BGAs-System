...
local function load_sprite(i, tex)
    ...
    local rgbglow = {1, 1, 1, 0}
    if tex.glow then rgbglow = {tex.glow[1], tex.glow[2], tex.glow[3], tex.glow[4]} end
    ...
    return Def.Sprite{
        ...
        OnCommand = function(self)
            ...
            -- rgb channels (glow)
            self:glow(rgbglow[1], rgbglow[2], rgbglow[3], rgbglow[4])
            ...
            self:SetUpdateFunction(function(self)
                ...
                elseif misc_effect then
                    ...
                    elseif effect == "scrollxy" then
                        ...
                        beat = (-0.5 + length + ((beat + 8) / ((i / num_sprites) + 1))) % length
